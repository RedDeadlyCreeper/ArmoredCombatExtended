...
ACF.Weapons.Ecm = ACF.Weapons.Ecm or {}
...
if CLIENT then
	...
	ecm_base.guicreate = function( Panel, Table ) ACFECMGUICreate( Table ) end
	ecm_base.guiupdate = function() return end
end
...
function ACF_DefineECM( id, data )
	data.id = id
	table.Inherit( data, ecm_base )
	ECM[ id ] = data
end
