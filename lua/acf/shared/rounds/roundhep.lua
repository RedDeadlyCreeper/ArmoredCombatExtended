...
function Round.guicreate( Panel, Table )
	...
	acfmenupanel:AmmoSelect(ACF.AmmoBlacklist.HEP)
...
list.Set( "ACFRoundTypes", "HEP", Round )  --Set the round properties
list.Set( "ACFIdRounds", Round.netid, "HEP" ) --Index must equal the ID entry in the table above, Data must equal the index of the table above
