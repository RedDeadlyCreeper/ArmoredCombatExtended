...
Round.name = "[CHF] - Chaff" --Human readable name
Round.model = "models/munitions/round_100mm_shot.mdl" --Shell flight model
Round.desc = "Aluminum particles for creating false radar signitures."
Round.netid = 26 --Unique ammotype ID for network transmission
...
function Round.network( Crate, BulletData )
	...
	Crate:SetNWString( "AmmoType", "CHF" )
...
function Round.cratetxt( BulletData )
	...
	local str =
	{
		...
		"Dissipation Rate: ", math.Round(DData.BurnRate, 1), " kg/s\n",
		"Lifetime: ", math.Round(DData.BurnTime, 1), " s\n"--,
	}
...
function Round.guicreate( Panel, Table )
	...
	acfmenupanel:AmmoSlider("FillerVol",0,0,1000,3, "Chaff Particulate Filler", "") --Hollow Point Cavity Slider (Name, Value, Min, Max, Decimals, Title, Desc)
...
function Round.guiupdate( Panel )
	...
	local PlayerData = {}
		...
		PlayerData.Type = "CHF"										--Hardcoded, match as Round.Type instead
	...
	acfmenupanel:AmmoSlider("FillerVol",Data.FillerVol,Data.MinFillerVol,Data.MaxFillerVol,3, "Chaff Particulate Filler", "Filler Mass : " .. (math.floor(Data.FillerMass * 1000)) .. " g")	--HE Filler Slider (Name, Min, Max, Decimals, Title, Desc)

	acfmenupanel:CPanelText("Desc", ACF.RoundTypes[PlayerData.Type].desc)	--Description (Name, Desc)
	acfmenupanel:CPanelText("LengthDisplay", "Round Length : " .. (math.floor((Data.PropLength + Data.ProjLength + Data.Tracer) * 100) / 100) .. "/" .. Data.MaxTotalLength .. " cm")	--Total round length (Name, Desc)
	acfmenupanel:CPanelText("VelocityDisplay", "Muzzle Velocity : " .. math.floor(Data.MuzzleVel * ACF.VelScale) .. " m/s")	--Proj muzzle velocity (Name, Desc)

	acfmenupanel:CPanelText("TempDisplay", "Radar Signiture : " .. math.Round(Data.FillerMass * 2.565, 1) .. "x")
...
list.Set( "SPECSRoundTypes", "CHF", Round )
