...
Round.name = "(APC) Armour Piercing Capped" --Human readable name
...
function Round.normalize( Index, Bullet, HitPos, HitNormal, Target)
	...
	Bullet.Pos = HitPos
	local FlightNormal = Bullet.Flight:GetNormalized() + (HitNormalBullet.Flight:GetNormalized()) * ACF.NormalizationFactor * NormieMult * 2
