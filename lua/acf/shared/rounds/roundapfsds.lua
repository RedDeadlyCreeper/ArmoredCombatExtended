...
ACF.AmmoBlacklist.APFSDS =  { "C","MG", "Al","HMG" ,"RAC", "SC","ATR" , "MO" , "RM", "SL", "GL", "HW", "SC", "BOMB" , "GBU", "ASM", "AAM", "SAM", "UAR", "POD", "FFAR", "ATGM", "ARTY", "ECM", "FGL"}
...
function Round.convert( Crate, PlayerData )
	...
	Data.ProjMass = Data.SubFrAera * (Data.ProjLength*7.9/1000) * 2.5 * 0.9 --Volume of the projectile as a cylinder * density of steel
	Data.ShovePower = 0.2
