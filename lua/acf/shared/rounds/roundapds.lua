...
function Round.guiupdate( Panel, Table )
	...
	acfmenupanel:CPanelText("LengthDisplay", "Round Length : "..(math.floor((Data.PropLength+Data.ProjLength+(math.floor(Data.Tracer*10)/10).."/"..(Data.MaxTotalLength).." cm")	--Total round length (Name, Desc)
