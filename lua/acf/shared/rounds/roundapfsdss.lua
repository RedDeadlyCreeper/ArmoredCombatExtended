...
ACF.AmmoBlacklist.APFSDSS =  { "AC", "SA","C","MG", "AL","HMG" ,"RAC", "SC","ATR" , "MO" , "RM", "SL", "GL", "HW", "SC", "BOMB" , "GBU", "ASM", "AAM", "SAM", "UAR", "POD", "FFAR", "ATGM", "ARTY", "ECM", "FGL"}
...
function Round.network( Crate, BulletData )
    ...
    Crate:SetNWString( "AmmoType", "APFSDSS" )
...
function Round.guicreate( Panel, Table )
    ...
    acfmenupanel:AmmoSelect( ACF.AmmoBlacklist.APFSDSS )
...
function Round.guiupdate( Panel, Table )
    ...
    local PlayerData = {}
        ...
        PlayerData.Type = "APFSDSS"                                     --Hardcoded, match ACFRoundTypes table index
...
list.Set( "APRoundTypes", "APFSDSS", Round )
list.Set( "ACFRoundTypes", "APFSDSS", Round )  --Set the round properties
list.Set( "ACFIdRounds", Round.netid, "APFSDSS" ) --Index must equal the ID entry in the table above, Data must equal the index of the table above