...
ACF.MenuFunc = {}
ACF.AmmoBlacklist = {}
ACF.Version = 12 -- REMEMBER TO CHANGE THIS FOR GODS SAKE, OMFG!!!!!!! -wrex   Update the changelog too! -Ferv
...
ACF.KEtoSpall = 1
ACF.AmmoMod = 1.1704		-- Ammo modifier. 1 is 1x the amount of ammo
ACF.ArmorMod = 1 
