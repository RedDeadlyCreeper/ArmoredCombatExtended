...
SWEP.CarrySpeedMul = 1.2 --WalkSpeedMult when carrying the weapon
...
function SWEP:InitBulletData()
	...
	self.BulletData = {}
		...
		self.BulletData.PropLength = 0.2 --Volume of the case as a cylinder * Powder density converted from g to kg		
