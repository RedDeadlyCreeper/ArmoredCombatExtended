...
-- Other settings
SWEP.Weight			= 10						
SWEP.ZoomAccuracyImprovement = 0.21 -- 0.3 means 0.7 the inaccuracy
SWEP.ZoomRecoilImprovement = 0.2 -- 0.3 means 0.7 the recoil movement 
SWEP.CrouchAccuracyImprovement = 0.15 -- 0.3 means 0.7 the inaccuracy
SWEP.CrouchRecoilImprovement = 0.3 -- 0.3 means 0.7 the recoil movement 
...
function SWEP:InitBulletData()
	...
	self.BulletData = {}
		...
		self.BulletData.PropLength = 0.8 --Volume of the case as a cylinder * Powder density converted from g to kg		
		self.BulletData.ProjLength = 3.0 --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
