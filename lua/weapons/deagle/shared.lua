...
-- Other settings
SWEP.Weight			= 10						
SWEP.ZoomAccuracyImprovement = 0.3 -- 0.3 means 0.7 the inaccuracy
SWEP.ZoomRecoilImprovement = 0.8 -- 0.3 means 0.7 the recoil movement 
SWEP.CrouchAccuracyImprovement = 0.1 -- 0.3 means 0.7 the inaccuracy
...
--		self.BulletData.DragCoef  = 0 --Alternatively manually set it
		...
		self.BulletData.PenAera = self.BulletData.FrAera^ACF.PenAreaMod*0.95
